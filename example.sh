...
do
    ...
    /usr/local/bin/rsync -a --exclude-from /Users/emichaelson/Code/trunk.professional_services/exclude.txt /Users/emichaelson/Code/trunk.professional_services/$i/ /Volumes/C/Users/emichaelson/sync/$i
done
